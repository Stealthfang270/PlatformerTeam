...
//Enter true or false for setNoone, true means that if the object has collision turned off or is not there, the function will set _inst to noone
//Make sure the object that is using this function has the following variables(case sensitive): overlapSize, overlap(a DS list), and _inst
